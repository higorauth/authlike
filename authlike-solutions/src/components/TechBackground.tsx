...
const TechBackground = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      {/* Hexagonal pattern overlay - hidden on mobile */}
      {!isMobile && (
      ...
      <div
        className="absolute top-1/4 left-1/4 w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full opacity-20 md:opacity-100"
        style={{ background: "radial-gradient(circle, hsl(217 91% 60% / 0.3) 0%, transparent 70%)", filter: isMobile ? "blur(60px)" : "blur(120px)" }}
      />
      {!isMobile && (
        <>
          <motion.div
      ...
      {/* Data stream lines - desktop only */}
